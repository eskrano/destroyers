...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
	...
	<meta name="keywords" content="разрушители, онлайн игра, пвп, сражения, pvp, приключения, прокачка героя, арена, битва, турнир, подземелья, бесплатная, mmorpg">
...
if (isset($user))
{
	...
	<table class="small yell h25 bgc_prg"><tbody><tr>
		...
		<td class="va_m w100"><div class="prg-bar"><div class="prg-blue" style="width:<?=$expProgress;?>%;"></div></div></td>
