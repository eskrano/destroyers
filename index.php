...
elseif(isset($user))
{
	...
	?>	<div class ='content'/>
		...
		<div class="ml10 mt10 mb10 mr10 sh small">
			<a class="medium lwhite tdn bold mt5" href="/arena">На Арену</a><br>
			<?=($user['fights_reset'] > $config['time'] ? "<span class ='grey2'/> Ваши 15 боев на арене закончились, приходите через
								".$h."ч ".$m."м ".$s."с
		</span>
